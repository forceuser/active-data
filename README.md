...
1.0.21 minified: [active-data.min.js](https://github.com/forceuser/active-data/releases/download/1.0.21/active-data.min.js)

#### Or just use CDN

```html
<script src="//gitcdn.xyz/repo/forceuser/active-data/1.0.21/dist/active-data.min.js">
</script>
```
